...
class ProductDisplay extends PureComponent {
  ...
  render() {
    ...
    const nextLabel = activeProductIndex + 1 > productFeatures.length - 1
        ...
        <div className="up-lender-product__inner">
          <div className="up-lender-product__track">
            {productFeatures.map(({
              ...
              const itemClasses = classNames('up-lender-product__track__item', {
                'up-lender-product__track__item--active': activeProductIndex === i,
                'up-lender-product__track__item--waiting': activeProductIndex !== i,
              })
              return (
                  ...
                  <div className={gridClasses}>
                    <div className="up-lender-product__nav">
                      ...
                      {features.map(({
                        ...
                        const itemClassName = classNames('up-lender-product__nav__item', {
                          'up-lender-product__nav__item--active': fi === activeIndex
                        })
                        return (
                          <div key={fi} className={itemClassName}>
                            <button
                              className="up-lender-product__nav__item__label"
                              onClick={this.handleNavOver.bind(this, fi)}
                            >
                              {label}
                            </button>
                    ...
                    <div className="up-lender-product__screenshots">
                      {features.map(({
                        ...
                        const className = classNames('up-lender-product__screenshot', {
